...
class Camera {
 ...
 public:
   ...
   */
  glm::mat4 SetProjection(double fov, double znear, double zfar);
   ...
   */
  void UpdateModel(glm::vec3 min, glm::vec3 max);
